...
export type KnowledgeRequest = {
  operation: "parseDoc" | "embedDocs" | "query"
  result?: {
    code: "success" | "error"
    message?: string
  }
  ...
  parseDoc?: {
    ...
    response?: KnowledgeParseResponse
  }

  embedDocs?: {
    request?: KnowledgeEmbedRequest
    response?: KnowledgeEmbedResponse
  }
...
export type KnowledgeParseRequest = {
  file_name: string
  file_id: string
  chunk_size: number
  chunk_overlap: number
}
export type KnowledgeParseResponse = Document[]

export type KnowledgeEmbedRequest = {
  docs: Document[]
  model?: string
}
export type KnowledgeEmbedResponse = boolean
