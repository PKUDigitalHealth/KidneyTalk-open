              ...
              <div className="relative z-10 break-all p-2">
                ...
                >
                  <div className="flex items-center gap-2">
                    {thread.metadata?.assistant_id === 'structuring' && (
                      <SquareCodeIcon size={16} className="text-[hsla(var(--text-secondary))]" />
                    )}
                    {thread.metadata?.assistant_id === 'summarisation' && (
                      <FileTextIcon size={16} className="text-[hsla(var(--text-secondary))]" />
                    )}
                    {thread.metadata?.assistant_id === 'jan' && (
                      <MessageCircleIcon size={16} className="text-[hsla(var(--text-secondary))]" />
                    )}
                    <span>{thread.title ?? thread.metadata?.title}</span>
                  </div>
                </h1>
              </div>
              <div
