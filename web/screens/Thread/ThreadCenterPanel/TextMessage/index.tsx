...
import { Modal, Button } from '@janhq/joi'

import { chatWidthAtom } from '@/helpers/atoms/Setting.atom'
import KnowledgeContent from './KnowledgeContent'
import { getLastRAGResults } from './KnowledgeContent'
          ...
          <div className="flex gap-2">
            {props.isCurrentMessage && !isUser && (
              <Modal
                ...
                title="Source Knowledge Snippets"
                content={<KnowledgeContent threadId={props.thread_id} />}
                trigger={
                  <Button size="small" theme="primary" variant="soft" disabled={getLastRAGResults(props.thread_id).length === 0}>
                    {'Source Docs [' + getLastRAGResults(props.thread_id).length + ']'}
                  </Button>
                }
              />
            )}
