...
import SummarisationScreen from '@/screens/Summarisation'
import StructuringScreen from '@/screens/Structuring'
...
const MainViewContainer = () => {
  ...
  switch (mainViewState) {
    ...
    case MainViewState.Summarisation:
      children = <SummarisationScreen />
      break

    case MainViewState.Structuring:
      children = <StructuringScreen />
      break

    case MainViewState.Knowledge:
      children = <KnowledgeScreen />
      break
